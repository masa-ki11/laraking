...
<main class="flex-grow">
    <div class = "form-row ">
        ...
        {{ csrf_field() }}
            <input type="date" name="from" class="form-control mr-sm-2" placeholder="from_date" value="<?php echo $data['from'];?>">
            <input type="submit" value="検索">
        </form>
    </div>
    <div class="ranking-ribbon mt-4"><h2>『{{$data['genre']}}』</h2></div>
    <div class="mobile_ranking-ribbon mt-4"><h3>『{{$data['genre']}}』</h3></div>
    
    <?php $index=0; ?>
    @foreach($rakuten  as $item)
    
        <div class="fit-box overflow-hidden mt-5" data-item="b1426f" data-rank="1" id="b1426f">
            <div class="p-4">
