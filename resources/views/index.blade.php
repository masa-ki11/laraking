...
<main class="flex-grow">
    <div class="ranking-ribbon mt-4"><h2>ランキング結果</h2></div>
            ...
            <div class="p-4">
                ...
                <div class="d-flex sm:space-x-4 mt-4">
                    <div class="sm:flex-shrink-0">
                        ...
                        <img alt="" class="js-lozad w-60 h-60 object-cover max-w-full mx-auto" src="{{ $item['smallImageUrls'][0]['imageUrl'] }}" data-loaded="true"></a>
